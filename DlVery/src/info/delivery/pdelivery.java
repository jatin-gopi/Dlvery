...
public class pdelivery extends HttpServlet
{
     ...
     PreparedStatement st = con.prepareStatement("select * from delviery");
     ...
     out.println("<td><font color=\"#008000\"> Pending </font></td>");
     out.println("</tr>");
     while(rs.next())
     {
     out.println("<tr>");
